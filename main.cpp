...
void processLightSource(GLFWwindow* window, glm::vec3* lightpos);
...
glm::vec3 LIGHTPOS(1.0f, 10.0f, 0.0f);
...
int main()
{
    ...
    Model ourModel("resources/objects/temple2/temple.obj");

    // for cube light source
    float vertices[] = {
        -0.5f, -0.5f, -0.5f,
         0.5f, -0.5f, -0.5f,
         0.5f,  0.5f, -0.5f,
    ...
    // configure the light's VAO and VBO - a 3d cube
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // input
        processInput(window);
        processLightSource(window, &LIGHTPOS);
